...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/09/17 11:44:12 by olrudenk          #+#    #+#              #
#    Updated: 2018/11/06 11:01:58 by olrudenk         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_memset.c ft_bzero.c ft_memcpy.c ft_memmove.c ft_memchr.c ft_memcmp.c \
	  ...
	  ft_strlcat.c ft_strchr.c ft_strstr.c ft_strnstr.c ft_strcmp.c ft_strncmp.c \
	  ft_atoi.c ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c \
	  ft_toupper.c ft_tolower.c ft_memset.c ft_memalloc.c ft_memdel.c ft_strnew.c \
...
OBJ = ft_memset.o ft_bzero.o ft_memcpy.o ft_memmove.o ft_memchr.o ft_memcmp.o \
	  ...
	  ft_strlcat.o ft_strchr.o ft_strstr.o ft_strnstr.o ft_strcmp.o ft_strncmp.o \
	  ft_atoi.o ft_isalpha.o ft_isdigit.o ft_isalnum.o ft_isascii.o ft_isprint.o \
	  ft_toupper.o ft_tolower.o ft_memset.o ft_memalloc.o ft_memdel.o ft_strnew.o \
